...
const ThreadCard = ({
  ...
  return (
    <article className={`flex w-full flex-col rounded-xl ${isComment? 'px-0 xs:px-7' : 'bg-dark-2 p-7 mt-6'}`}>
      <div className="flex items-start justify-between">
        <div className="flex w-full flex-1 flex-row gap-4">
          <div className="flex flex-col items-center">
            ...
            >
                <Image src={author.image} alt='profile image'
                fill
            ...
            <div>
              ...
              <div className={`${isComment && 'mb-10'} mt-2 text-small-regular text-light-2`}>
